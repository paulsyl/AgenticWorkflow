...
name: prototype
description: >
  Build throwaway code that answers a design question. No PRD, no review council,
  no ceremony. Two branches: Logic (terminal/backend exploration) or UI (visual
  exploration). Clearly marked as discardable. Summon via @prototype or /prototype.
---
