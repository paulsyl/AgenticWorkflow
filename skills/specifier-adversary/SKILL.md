...
description: >
  Adversarial peer review of the @specifier-grill alignment summary before PRD generation.
  Adopts a rotating domain-expert persona (Compliance, SRE, Fraud, Support, Accessibility,
  FinOps, Legal/Privacy, Adversarial User) to probe blind spots the primary grilling missed.
  Requirements-only. Reads only the self-contained alignment file.
  Summon via @specifier-adversary or /specifier-adversary.
---
