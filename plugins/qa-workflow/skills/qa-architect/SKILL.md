...
name: qa-architect
description: >
  QA Architect agent that analyzes BRD/PRD documents to design a comprehensive
  black-box test plan. Outputs a strict JSON array of test cases with positive
  and negative scenarios. Summon via @qa-architect or /qa-architect.
---
