...
name: architect
description: >
  Translate a rigid PRD contract into technical blueprints. Produces a System
  Architecture document and vertical-sliced Phase files. Each phase is a
  demoable feature slice through all layers (schema, API, UI, tests), not a
  horizontal layer. Summon via @architect or /architect.
---
